...
DB_PARAMS = {
    "dbname": os.getenv("PG_DB", "targibot2"),
    "user": os.getenv("PG_USER", "targibot02"),
    "password": os.getenv("PG_PASSWORD", "g4jwc5X9skxpDTCgkIqQ8msGk2HEdFly"),
    "host": os.getenv("PG_HOST", "dpg-d25oslk9c44c73dkb980-a"),
